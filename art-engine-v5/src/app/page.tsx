      ...
      <AnimatePresence mode="wait">
        ...
        {activeApp === 'jobtracker' && (
          ...
          >
            ...
            <button
              onClick={() => setActiveApp('dashboard')}
              className="fixed bottom-6 left-6 z-[100] bg-zinc-900 border border-white/10 text-zinc-400 hover:text-white px-3 py-1.5 rounded-lg text-xs font-bold transition-all"
            >
              Back to OS
            </button>
          </motion.div>
