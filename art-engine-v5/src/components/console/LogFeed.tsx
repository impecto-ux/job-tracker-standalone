                        ...
                        >
                            ...
                            <div className="flex justify-center gap-2">
                                <div className="relative group/menu">
                                    ...
                                    {/* Hover Menu Container (Invisible Bridge) */}
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 pb-2 w-48 opacity-0 group-hover/menu:opacity-100 pointer-events-none group-hover/menu:pointer-events-auto transition-all transform translate-y-2 group-hover/menu:translate-y-0 z-50">

                                        {/* Actual Menu Content */}
                                        <div className="bg-zinc-900 border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col">
                                            <button
                                                onClick={async () => {
