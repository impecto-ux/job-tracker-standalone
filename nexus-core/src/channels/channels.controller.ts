...
export class ChannelsController {
    ...
    @Post(':id/messages')
    postMessage(@Param('id') id: string, @Body() body: { content: string; mediaUrl?: string; mediaType?: string }, @Request() req) {
        return this.channelsService.postMessage(+id, body.content, req.user.userId, body.mediaUrl, body.mediaType);
    }
}
